      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar transition-all duration-150",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile}>
        ...
        >
          <SidebarInset className="flex h-full flex-col overflow-hidden bg-sidebar p-0">
            {children}
          </SidebarInset>
        </SheetContent>
        <div
        ...
        >
          <div
            ...
            className={cn(
              ...
              variant === "floating" && "m-2 rounded-lg shadow-[0_0_0_1px_hsl(var(--sidebar-border))] shadow-black/20",
              variant === "inset" && "m-2 rounded-r-lg"
            )}
          />
          <div
            className={cn(
              "duration-200 fixed inset-y-0 left-0 w-[--sidebar-width] transition-[width,left] ease-linear",
              "group-data-[collapsible=icon]:w-[--sidebar-width-icon]",
              "group-data-[side=right]:border-l group-data-[side=left]:border-r",
              "border-sidebar-border",
              variant === "floating" && "m-2 rounded-r-lg shadow-[0_0_0_1px_hsl(var(--sidebar-border))] shadow-black/20",
              variant === "inset" && "m-2 rounded-r-lg",
              className
            )}
            data-sidebar="sidebar"
            ...
            style={
              {
                left: side === "right" ? "var(--sidebar-width)" : 0,
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1 flex h-5 max-w-[50%] items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground select-none pointer-events-none",
